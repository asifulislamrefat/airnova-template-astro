    ...
    <section className="bg-white py-16 lg:py-28">
      <div className="container-x flex flex-col items-center gap-12 sm:gap-16">
        ...
        <div className="flex w-full flex-col gap-2 lg:flex-row lg:items-start">
          {/* Left card — dark */}
          <div className="flex h-[2000px] xl:h-[500px] flex-1 flex-col justify-between rounded-[20px] bg-[#070606] p-8">
          ...
          {/* Right card — light */}
          <div className="flex h-[2000px] xl:h-[500px] flex-1 flex-col justify-between rounded-[20px] bg-[#f5f5f5] p-8">
            <div className="flex items-start justify-between">
              <div className="flex flex-col gap-2">
